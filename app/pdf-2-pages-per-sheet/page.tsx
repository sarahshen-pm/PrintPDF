      ...
      <div className="max-w-3xl w-full z-10 relative">
        ...
        <section className="mt-16 bg-white/60 backdrop-blur-md p-8 rounded-3xl border border-white/80 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
          <h2 className="text-2xl font-bold mb-4 text-slate-800">
            What is a 2-pages-per-sheet PDF?
          </h2>
          <p className="text-slate-600 leading-relaxed text-lg">
            This tool lets you elegantly combine 2 PDF pages into one single sheet, significantly reducing paper usage and improving readability for study notes or slides. Your files are processed entirely in your browser—no data is ever uploaded to our servers. Fast, secure, and incredibly compact.
          </p>
        </section>
      </div>
    </main>
